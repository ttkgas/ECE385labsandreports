...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/c:/385/lab67redo/lab67redo.tmp/hdmi_text_controller_v2_0_project1/hdmi_text_controller_v2_0_project1.gen/sources_1/ip/clk_wiz_0" \
       +incdir+"../../../../hdmi_text_controller_v2_0_project1.gen/sources_1/ip/clk_wiz_0" \
       -input simulate.do
}
